...
class Cell:
    ...
    def __sub__(self, other):
        if self.__number > other.__number:
            ...
            raise ValueError('Отрицательный рост клетки!')
    ...
    def make_order(self, columns):
        cells_str = '*' * self.__number
        return '\n'.join([cells_str[i:i + columns] for i in range(0, len(cells_str), columns)])
...
print('Сложение:')
print((my_cell1 + my_cell2).make_order(5))
print('Вычитание:')
# print((my_cell1-my_cell2).make_order(5),'\n')
print((my_cell2 - my_cell1).make_order(2))
print('Умножение:')
print((my_cell1 * my_cell2).make_order(50))
print('Деление:')
print((my_cell3 / my_cell1).make_order(2))
